...
1. A rank (1 = best)
2. A brief reason in Traditional Chinese (1-2 sentences)
...
Be objective. Judge only the content, not writing style. Focus on factual accuracy and helpfulness. Write all reasons in Traditional Chinese.`;
}
...
Provide your synthesized answer directly in Traditional Chinese (繁體中文), without meta-commentary about the synthesis process.`;
}
